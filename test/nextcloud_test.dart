...
class Config {
  ...
  factory Config.fromJson(Map<String, dynamic> json) => Config(
        ...
        testDir: (json['testDir'] as String).endsWith('/')
            ? json['testDir'].substring(
                0,
                json['testDir'].length - 1,
              ) as String
...
void main() {
  final config = Config.fromJson(
    json.decode(File('config.json').readAsStringSync()) as Map<String, dynamic>,
  );
    ...
    () {
      test(
        ...
        () async {
          ...
          expect(
            status.searchCapabilities,
            contains('<DAV:basicsearch>'),
          );
        },
      );
      test(
      ...
      test(
        ...
        () async {
          expect(
            (await client.webDav.mkdir(config.testDir)).statusCode,
            equals(201),
          );
        },
      );
      test(
        ...
        () async {
          expect(
            (await client.webDav.ls(config.testDir)).length,
            equals(0),
          );
        },
      );
      ...
      test(
        'List directory with properties',
        () async {
      ...
      test(
        ...
        () async {
          ...
          final files = await client.webDav.ls(config.testDir);
          expect(
            files.where((f) => f.name == 'test.txt'),
            hasLength(1),
          );
          expect(
            files.where((f) => f.name == 'test2.txt'),
            hasLength(1),
          );
        },
      );
      ...
      test(
        ...
        () async {
          ...
          expect(
            files.where((f) => f.name == 'test3.txt'),
            hasLength(1),
          );
        },
      );
      ...
      test(
        ...
        () async {
          ...
          customNamespaces.forEach(
            (
              ns,
              prefix,
            ) =>
                client.webDav.registerNamespace(
              ns,
              prefix,
            ),
          );
          ...
          expect(
            file.getOtherProp(
              'custom',
              customNamespaces.keys.elementAt(1),
            ),
  ...
  group(
    ...
    () {
      ...
      test(
        'Create conversation',
        () async {
          token = await client.talk.conversationManagement.createConversation(
      ...
      test(
        ...
        () async {
          expect(
            await client.talk.conversationManagement.addParticipant(
              token,
              config.shareUser,
            ),
            isNull,
      ...
      test(
        ...
        () async {
          expect(
            await client.talk.conversationManagement.promoteUserToModerator(
              token,
              config.shareUser,
            ),
            isNull,
          ...
          expect(
            await client.talk.conversationManagement.demoteUserFromModerator(
              token,
              config.shareUser,
            ),
            isNull,
      ...
      test(
        ...
        () async {
          expect(
            await client.talk.conversationManagement.deleteParticipant(
              token,
              config.shareUser,
            ),
            isNull,
  ...
  group(
    ...
    () {
      ...
      test(
        ...
        () async {
          expect(
            await client.preview.getPreviewByPath(
              imageRootPath,
              64,
              64,
            ),
      ...
      test(
        ...
        () async {
          expect(
            await client.preview.getPreviewById(
              previewFile.id,
              64,
              64,
            ),
      ...
      test(
        'Get preview stream by path',
        () async {
          expect(
            await client.preview.getPreviewStreamByPath(
              imageRootPath,
              64,
              64,
            ),
      ...
      test(
        'Get preview stream by id',
        () async {
          expect(
            await client.preview.getPreviewStreamById(
              previewFile.id,
              64,
              64,
            ),
      ...
      test(
        ...
        () async {
          expect(
            await client.preview.getThumbnail(
              imageRootPath,
              64,
              64,
            ),
      ...
      test(
        ...
        () async {
          expect(
            await client.preview.getThumbnailStream(
              imageRootPath,
              64,
              64,
            ),
